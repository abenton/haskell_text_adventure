...
-- | Convert a user's command into an Action in the game
...
-- | Convert a user's request about an object into an Action in the game
...
-- | Convert a user's request to create a bag into an Action in the game
parseBag :: String -> [String] -> Maybe Action
parseBag "mkbag" (x:_) = Just (MkBag (Bag x "" []))
parseBag _ _           = Nothing

-- | Convert a user's request to create a player into an Action in the game
